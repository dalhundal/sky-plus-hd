...
var SkyPlusHD = module.exports = function(options) {
  ...
  var _init_ = function() {
    ...
    if (!options.monitorHost) options.monitorHost = guessLocalIP();
    if (!options.host) {
  ...
  var cancelSubscription = function(host,port,fnCallback) {
    if (!subscriptionSID) {
  ...
  var changeChannelID = function (id) {
    changeChannelHexID(id.toString(16));
  }

  var changeChannelHexID = function (id) {
  ...
  var requestSubscription = function(host,port,fnCallback) {
  ...
  this.monitor = function() {
    var that = this;
    var subscriptionID = requestSubscription(options.monitorHost,options.monitorPort,function() {
